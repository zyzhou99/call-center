...
function InboxContent() {
  ...
  const activeMessages = activeConversationId ? messagesState[activeConversationId] || [] : [];
  const activeProfile = activeConversationId ? mockProfiles[activeConversationId] || null : null;
