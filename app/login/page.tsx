...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      {/* 右侧登录区 */}
      <div
        className="flex-[1] flex items-center align-left"
        style={{ backgroundColor: "#FAF7F2" }}
      >
        {/* 底部右下角水印，用 next/image */}
        <div
          className="absolute bottom-0 right-0 opacity-100 pointer-events-none select-none"
        >
          <Image
            src={wynnWater}
            alt="Wynn watermark"
            className="h-46 w-auto"   // 可以改成 h-24 / h-40 调整大小
            priority={false}
          />
        </div>
            ...
            <div className="flex items-center justify-between pt-1 text-xs">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  style={{ borderColor: "#D4CCBF", accentColor: "#C59A4A" }}
                />
