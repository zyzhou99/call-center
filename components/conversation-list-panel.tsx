...
import { getLastMessage, getMessagePreview, getTimeLabel } from '@/lib/conversation-utils';
...
export function ConversationListPanel({
  ...
  return (
    <div className="w-96 flex flex-col" style={{ backgroundColor: '#F9F8F6', borderRight: '1px solid var(--divider)' }}>
      <div className="p-4" style={{ borderBottom: '1px solid var(--divider)', backgroundColor: '#F9F8F6' }}>
...
function ConversationRow({ conversation, isActive, onClick, messages }: ConversationRowProps) {
